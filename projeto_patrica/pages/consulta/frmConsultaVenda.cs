    ...
    public partial class frmConsultaVenda : projeto_patrica.pages.consulta.frmConsulta
    {
        ...
        private void listV_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (listV.SelectedItems.Count > 0)
            {
                ...
                oVenda.OCliente = vendaSelecionada.OCliente;
                oVenda.OFuncionario = vendaSelecionada.OFuncionario;
                oVenda.DataEmissao = vendaSelecionada.DataEmissao;
                oVenda.Itens = vendaSelecionada.Itens;
                oVenda.ACondicaoPagamento = vendaSelecionada.ACondicaoPagamento;
                oVenda.Parcelas = vendaSelecionada.Parcelas;
                oVenda.MotivoCancelamento = vendaSelecionada.MotivoCancelamento;
                oVenda.Ativo = vendaSelecionada.Ativo;
                oVenda.DataCadastro = vendaSelecionada.DataCadastro;
                oVenda.DataUltimaEdicao = vendaSelecionada.DataUltimaEdicao;
            }
        }
    }
}